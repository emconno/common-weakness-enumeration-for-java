                ...
                switch (choice) {
                    ...
                    case 3: // View available flights
                        ...
                        if (flights.length >= 2) {
                            ...
                            System.out.println("\nCompatibility Check:");
                            System.out.println(flights[0].getFlightNumber() + " and " + flights[1].getFlightNumber() + " are " + (compatible ? "compatible" : "not compatible"));
                        }
                        break;    
        ...
        while(outerLoopRunning){
            ...
            switch(choice){
                case 1:
                    ...
                    String name = Main.readCleanLine(scanner);
                    ...
                    String password = Main.readCleanLine(scanner);
                ...
                case 2: 
                    ...
                    System.out.println("Enter your name: ");
                    String userName = Main.readCleanLine(scanner);
                    System.out.println("Enter your age");
                        ...
                        if(currentUsers[i] != null){//CWE-476: NULL Pointer Dereference: achieved by checking if null before trying to access it
                            if(currentUsers[i].getName().equals(userName) && currentUsers[i].getAge() == userAge){
                                ...
                                if(userPassword.equals(currentUsers[i].getPassword())){
                                    ...
                                    Main.handleUserSelection(Main.flights, scanner, curUser);
                                    break;
                                } else {
